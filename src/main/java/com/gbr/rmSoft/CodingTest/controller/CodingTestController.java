...
public class CodingTestController {
	...
	public ResultData getItemList(@RequestParam(defaultValue = "0") int item_id,
			@RequestParam(defaultValue = "") String item_nm, @RequestParam(defaultValue = "0") int com_id) {
	...
	@ResponseBody
	public ResultData getComList(@RequestParam(defaultValue = "0") int com_id,
			@RequestParam(defaultValue = "") String com_nm, @RequestParam(defaultValue = "") String com_bossNm) {
	...
	@ResponseBody
	public ResultData getCtmList(@RequestParam(defaultValue = "0") int ctm_id,
			@RequestParam(defaultValue = "") String ctm_nm, @RequestParam(defaultValue = "") String ctm_hp) {
	...
	public ResultData getCifList(@RequestParam(defaultValue = "0") int ctminfo_buySeq, String ctminfo_reg_date,
			...
			@RequestParam(defaultValue = "") String ctm_nm, @RequestParam(defaultValue = "") String item_nm,
			@RequestParam(defaultValue = "") String item_price) {

		int cifCount = cifService.getCountCif();

		List<CTMINFO_TB> cifList = cifService.getCifList(ctminfo_buySeq, ctminfo_reg_date, ctm_id, item_id, ctm_nm,
				item_nm, item_price);
